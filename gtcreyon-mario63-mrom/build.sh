...
flash-patcher --inputswf $input --folder patches --mainfile base.stage --output .mrom-cache/base.swf --xml

echo "Building core script..."
python build_core.py -o .mrom-cache/core.as -d output/help.md

echo "Patching in MROM code..."
flash-patcher --inputswf .mrom-cache/base.swf --folder patches --mainfile inject.stage --output output/MushROM.swf
